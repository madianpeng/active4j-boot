  layui.config({
    ...
    var Page = {
    	...
    	url: CXL.ctxPath + '/sys/user/datagrid?type='+$("#type").val(),
    	...
    	initColumn: function() {
    		return [[
    		        ...
    		        ,{field:'telNo',title: '手机号', width:'20%'}
    		        ,{field:'email',title: '邮箱', width:'20%'}
    		        ,{field:'status',title: '状态', width:'10%', templet:"#online-status"}
    		        ,{field:'createDate',title: '创建时间', width:'15%', templet: '<div>{{ layui.laytpl.toDateString(d.createDate) }}</div>'}
